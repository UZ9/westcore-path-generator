...
export default function Model(props) {
  ...
  const group = useRef()
  const { nodes, materials } = useGLTF('/TiP_Colors_Fixed.glb')
  ...
  return (
    <group key={"node"} ref={group} {...props} dispose={null}>
      ...
      <mesh
        ...
        rotation={[Math.PI / 2, 0, 0]}
      />
      <group name="Blue Mobo" rotation={[Math.PI / 2, 0, 0]}>
      ...
      <group name="Blue Mobo 2" rotation={[Math.PI / 2, 0, 0]}>
        ...
        <mesh name="Ring" geometry={nodes.TiP_Inches1275_8.geometry} material={nodes.TiP_Inches1275_8.material} onClick={sayClicked} />
      </group>
      <group rotation={[Math.PI / 2, 0, 0]}>
...
useGLTF.preload('/TiP_Colors_Fixed.glb')
